...
**Rule: If it's not written to a file, you don't remember it.** Period.

- **Daily notes:** `memory/YYYY-MM-DD.md` (create `memory/` if needed) — raw logs
  - Every entry must be timestamped: `## YYYY-MM-DD HH:MM UTC`
  - Log: decisions, tasks, preferences, context, mistakes, what you learn about Robin
  - Real-time logging during conversations
  - Nothing survives session restarts unless written to a file

- **Long-term:** `MEMORY.md` — curated memories
  - Who Robin is: communication style, what they care about, what annoys them, projects, goals
  - Significant decisions and why
  - Lessons learned
  - Active projects and preferences
  - Review daily journals periodically (every few days) and distill into here
